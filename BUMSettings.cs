...
namespace BlockUnwantedMinutiae
{
    public class BUMSettings : ModSettings
    {
        public static IReadOnlyList<string> genericMessage_labels { get; } = new string[]
        {
            ...
            "DescriptionIdeoWarnRoleApparelOverlapsDesiredApparel",
        ...
        public static IReadOnlyList<string> genericAlert_labels { get; } = new string[]
        {
            ...
            // Alerts.xml
            "NeedSlaveBeds",
            "SlavesUnsuppressedLabel",
            "SlaveUnattendedLabel",
            "SlaveUnattendedMultipleLabel",
            "RitualExpected",
            "RitualOpportunity",
            "RitualExpectedFor",
            "RitualExpirationTime",
            "RitualExpiresIn",
            "IdeoBuildingMissing",
            "IdeoBuildingExpectations",
            "IdeoBuildingDisrespected",
            "QuestPartRaidsDelay",
            "IdeoRoleEmpty",
            "IdeoRolesEmpty",
            "AncientAltarThreatsWaking",
            "AlertNoRecentSlaughter",
            "BodySizeOrAbove",
            "AlertRitualComing",
            "AlertRitualComingEntry",
            "AlertAgeReversalDemandNear",
            "AlertGauranlenTreeWithoutDryadTypeLabel",
            "AlertConnectedPawnNotAssignedToPlantCuttingLabel",
            "AlertFuelNodeIgniting",
            "AlertInfestationArriving",
            "AlertHostilesWakingUp",
            "AlertCasketOpening",
            "AlertSlaveRebellionLikely"
        };
